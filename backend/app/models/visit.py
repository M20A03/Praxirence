...
class Visit(Base):
    ...
    day3_followup_response = Column(JSON, nullable=True)  # {status: "better"|"recovering"|"worse", notes: "...", responded_at: "..."}

    day7_followup_status = Column(String(30), default="scheduled", nullable=False)  # scheduled, sent, responded, dismissed
    day7_followup_sent_at = Column(DateTime, nullable=True)
    day7_followup_response = Column(JSON, nullable=True)  # {status: "better"|"recovering"|"worse", notes: "...", responded_at: "..."}
