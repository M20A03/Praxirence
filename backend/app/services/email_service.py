...
def store_email_otp(email: str, code: str, ttl_minutes: int = 10):
    """Store email OTP with expiry"""
...
class EmailService:
    ...
    def send_doctor_verification_otp(
        ...
        subject = f"Praxirence Clinical Portal: Your Verification Code is {otp_code}"
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1>PRAXIRENCE</h1>
              <p>Clinical Intelligence & Healthcare Consultation Portal</p>
            </div>
            <div class="content">
              <div class="greeting">Hello {name_display},</div>
              <p style="font-size: 14px; line-height: 1.6; color: #334155;">
                We received a request to verify your institutional clinician identity for Praxirence. Please use the verification code below:
              </p>
              ...
              <p class="warning">
                <strong>Security Notice:</strong> Never share this verification code with anyone. Praxirence medical staff will never ask for your authentication credentials. If you did not initiate this request, please disregard this email.
              </p>
            </div>
            <div class="footer">
              End-to-End Encrypted • DPDP Act 2023 & ABDM Aligned • Sent from noreply@praxirence.com
            </div>
          </div>
        </body>
        </html>
        ...
        plain_text = (
            ...
            f"— Praxirence Clinical Portal Security Team"
        )
