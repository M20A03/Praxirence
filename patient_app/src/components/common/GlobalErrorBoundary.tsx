...
/**
 * Hospital-Grade Hierarchical Error Boundary
 * Traps runtime rendering errors, isolates failure blast radius to the specific component,
 * and renders a secure clinical fallback UI instead of crashing the app to the OS home screen.
 */
export class GlobalErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo): void {
    ...
    CrashResilience.recordEvent({
      ...
      type: 'CRASH_AVOIDED',
      message: `[ErrorBoundary] ${sanitizedMsg}`,
    ...
    if (this.state.hasError) {
        ...
        return (
          <View style={styles.compactContainer}>
            ...
            <Text style={styles.compactDesc}>
              Your healthcare data is intact. Tap below to reload this section.
            </Text>
            <TouchableOpacity style={styles.compactRetryBtn} onPress={this.handleReset} activeOpacity={0.8}>
              ...
              <Text style={styles.compactRetryBtnText}>Reload Component</Text>
            </TouchableOpacity>
          </View>
        );
      }
      ...
      return (
        <View style={styles.fullScreenContainer}>
          ...
          <Text style={styles.errorTitle}>Protected Clinical Session</Text>
          <Text style={styles.errorDesc}>
            A display component encountered a temporary interruption. All your consultations, prescriptions, and health telemetry remain fully secure and unaffected.
          </Text>
          ...
          <TouchableOpacity style={styles.primaryRecoverBtn} onPress={this.handleReset} activeOpacity={0.8}>
            ...
            <Text style={styles.primaryRecoverBtnText}>Restore View</Text>
          </TouchableOpacity>
        </View>
      );
    }
