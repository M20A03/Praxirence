        ...
        <div className="card" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                {selectedPatient.consent_status ? (
                  <span className="badge badge-success">
                    <CheckCircle2 size={13} /> DPDP Consent Active
                  </span>
                ) : (
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            <button
              ...
              title={selectedPatient.consent_status ? 'Revoke patient communication consent' : 'Grant patient communication consent'}
            >
              {selectedPatient.consent_status ? (
                <>
                  <ShieldAlert size={16} />
            ...
            <form onSubmit={handleCreatePatient}>
              ...
              <div className="input-group">
                ...
                <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                  Phone is encrypted with AES-256 at rest for patient verification.
                </span>
              </div>
