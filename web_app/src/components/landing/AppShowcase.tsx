            ...
            {activeTab === 'doctor' && (
              <div className="phone-screen">
                ...
                <div style={{ marginTop: 'auto', background: 'rgba(16, 185, 129, 0.08)', border: '1px solid rgba(16, 185, 129, 0.25)', borderRadius: '10px', padding: '8px' }}>
                  ...
                  <button
                    onClick={() => {
                      ...
                      window.dispatchEvent(new CustomEvent('praxirence_toast', {
                        detail: {
                          type: 'success',
                          title: 'Care Plan Dispatched',
                          message: 'Encrypted care plan dispatched to Patient App with automated alarms.',
                        }
                      }));
                    }}
                    style={{
                  ...
                  >
                    <Send size={11} />
                    <span>Verify & Dispatch to App</span>
                  </button>
                </div>
              </div>
            )}
            ...
            {activeTab === 'patient' && (
              <div className="phone-screen">
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    <span style={{ fontSize: '9.5px', color: '#059669', fontWeight: 700, display: 'block' }}>ऐप में सिंक हुआ • Active</span>
                    <span style={{ fontSize: '8.5px', color: '#64748b' }}>PDF केयर प्लान और अलार्म सक्रिय हैं</span>
                  </div>
          ...
          {activeTab === 'doctor' ? (
            <div className="feature-points">
              ...
              <div className="feature-item">
                ...
                <div>
                  <h4>Instant In-App Care Plan Sync</h4>
                  <p>
                    Delivers cryptographic, tamper-proof care plan summaries and medication schedules directly into the patient's Praxirence app with automated alarms.
                  </p>
                </div>
              </div>
