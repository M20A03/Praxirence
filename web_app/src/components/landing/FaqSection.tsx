...
export const FaqSection: React.FC = () => {
  ...
  const faqs: FaqItem[] = [
    ...
    {
      question: "Why is physician verification mandatory before care plan dispatch?",
    ...
    {
      question: "How do patients receive and access their care plan?",
      answer: "Patients receive their full signed care plan, vernacular voice guidance, prescription PDF, and scheduled medication alarms directly inside the native Praxirence Care App with full offline access and complete biometric encryption."
    },
    {
