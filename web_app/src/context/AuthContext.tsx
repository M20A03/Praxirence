...
interface AuthContextType {
  ...
  loginDoctorEmailOtp: (email: string, code: string) => Promise<AuthResponse>;
  loginDoctorGoogle: (data?: any) => Promise<AuthResponse>;
  loginPatientEmailOtp: (email: string, code: string) => Promise<AuthResponse>;
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const loginDoctorEmailOtp = async (email: string, code: string): Promise<AuthResponse> => {
    const data = await api.verifyDoctorEmailOtp(email, code);
    saveAuthSession(data);
    return data;
  };
  ...
  const loginPatientEmailOtp = async (email: string, code: string): Promise<AuthResponse> => {
    const data = await api.verifyPatientEmailOtp(email, code);
    saveAuthSession(data);
    return data;
  };
